...
class ExtendedRelationshipModule_20 extends RelationshipsChartModule implements 
  ...
  public function __construct(TreeService $tree_service) {
    ...
    $this->listController = new ExtendedIndividualListController_20(
  ...
  public function onBoot(): void {
      ...
      $router_container->getMap()
            ->get(ExtendedIndividualListController_20::class, static::ROUTE_URL_LIST, $this->listController);
      ...
      View::registerCustomView('::lists/individuals-table-with-patriarchs', $this->name() . '::lists/individuals-table-with-patriarchs_20');

      //same here
      View::registerCustomView('::lists/surnames-table', $this->name() . '::lists/surnames-table-switch_20');            
      View::registerCustomView('::lists/surnames-table-with-patriarchs', $this->name() . '::lists/surnames-table-with-patriarchs_20');
  ...
  */
  ...
  public function handle(ServerRequestInterface $request): ResponseInterface
  {
      ...
      return $this->viewResponse($this->name() . '::page_20', [
          'ajax_url'           => $ajax_url,
          'ancestors'          => $ancestors,
