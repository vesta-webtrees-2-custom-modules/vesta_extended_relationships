...
class ExtendedIndividualListController_20 extends IndividualListModule {
  ...
  public function __construct(
          ...
          ExtendedRelationshipModule_20 $module) {
  ...
  protected function surnamesWithPatriarchs(
    ...
    //preload patriarchs
    Individual::load($tree, $patriarchsXrefs);
    
    return $list;
  }
  
  //originally returns Individual[], we adjust this to be able to switch view in individuals-table-switch.phtml
  public function individuals(
    ...
    $originalArray = parent::individuals($tree, $surn, $salpha, $galpha, $marnm, $fams, $locale);
    ...
    foreach ($originalArray as $individual) {
    ...
    $wrapped = [];
    $wrapped[] = new IndividualsWithPatriarchs($originalArray, $list);
    return $wrapped;
  }
